...
export default function TechIcon({ src, alt }: { src: string, alt: string }) {
    return (
        <div className="relative group flex items-center justify-center transition-transform duration-300 hover:scale-110 cursor-pointer w-12 h-12">
            ...
            <Image
                ...
                alt={alt}
                fill
                className="object-contain filter grayscale invert opacity-75"
            />
